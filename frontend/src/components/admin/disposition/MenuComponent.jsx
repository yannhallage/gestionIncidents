...
import '../../../styles/adminMenu.css'; // CSS file for styles
import OptionComponent from '../interface/optionComponent';

const MenuComponent = () => {

  const [optionSelect, setOptionSelect] = useState(<OptionComponent />)
  return (
    <>
      <nav className="navbar">
        ...
        <div className="navbar-region">
          <select>
            <option value="canada-southeast">Acces rapide (Details)</option>
            {/* Add more options if needed */}
          </select>
        </div>
        <div className="navbar-icons">
          <span className="icon animate__bounce">
      ...
      <AdminContext.Provider value={{ optionSelect, setOptionSelect }}>
